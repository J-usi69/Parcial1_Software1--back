...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedUsuarios() {
        List<Usuario> usuariosPorDefecto = List.of(
                ...
                buildDefaultUser("pedro.ventas", "pedro.ventas", "Pedro Senior Sales", RolUsuario.SOLICITANTE,
                        "Ventas"),

                // --- SOLICITANTES GENERALES ---
                buildDefaultUser("solicitante", "solicitante", "Usuario Estándar Juan", RolUsuario.SOLICITANTE,
                        "Ventas"),
                buildDefaultUser("ana", "ana", "Ana Martínez", RolUsuario.SOLICITANTE, "Ventas"),
                buildDefaultUser("carlos", "carlos", "Carlos Ruiz", RolUsuario.SOLICITANTE, "Recursos Humanos"));
    ...
    private void crearYGuardarSolicitud(String titulo, String desc, Prioridad prio, String depto, String creador) {
        ...
        s.registrarTransicion(null, EstadoWorkflow.PENDIENTE, creador, "SOLICITANTE",
                "Creado automáticamente por sistema");
